        ...
        <div className="hero-container container">
          ...
          <div className="hero-text">
            ...
            <div className="hero-links animate-fade-in-up delay-5">
              ...
              */}
              <a href="https://github.com/LakenHarville" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="GitHub">
              ...
              <a href="https://www.linkedin.com/in/laken-harville-635783226/" target="_blank" rel="noopener noreferrer" className="social-link" aria-label="LinkedIn">
                <svg viewBox="0 0 24 24" fill="currentColor" width="22" height="22">
